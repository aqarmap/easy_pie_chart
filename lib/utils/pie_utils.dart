...
abstract class Utils {
  ...
  static double getAngleFromCordinates(
  ...
  static double getPositiveAngle(double tapAngle) {
  ...
  static double getAngleIn360(double startAngle) {
    if (startAngle < 0) {
  ...
  static bool isCurrentPieTap(
      double startAngle, double sweepAngle, double tapAngle) {
  ...
  static int? getIndexOfTappedPie(
